...
+
カスタムバックアップ（ SnapVault ）ポリシーを選択した場合は、ポリシーに関連付けられたラベルがソースボリューム上の Snapshot コピーのラベルと一致する必要があります。を参照してください。 link:concept-replication-policies.html#how-backup-policies-work["バックアップポリシーの仕組みを説明します"]。
